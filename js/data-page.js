...
// Page-specific scripts for data.html (data slug)
// ============================================
...
// Independent consultant toggle functionality (for referrers view)
...
// Initialize page when form is ready
document.addEventListener('formReady', () => {
    console.log('🚀 Data page (suggestions mode) ready');
});
