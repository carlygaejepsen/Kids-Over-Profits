<?php
/**
 * Check what data form script functions.php is trying to load
 */
...
echo json_encode([
    ...
    'expected_file_path' => get_stylesheet_directory() . ($matches[1] ?? '/js/data-form/data-form.v4.js'),
    'file_exists' => file_exists(get_stylesheet_directory() . ($matches[1] ?? '/js/data-form/data-form.v4.js')),
