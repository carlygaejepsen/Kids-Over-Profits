...
// Never print PHP notices into the JSON body — a stray warning breaks
// response.json() on the client, which silently falls back to stale
// localStorage data instead of live records.
