...
Required:
    ...
    INSPECTIONS_API_KEY   API key for inspections-write.php
...
API_KEY        = os.environ.get("INSPECTIONS_API_KEY", "CHANGE_ME")
...
OUTPUT_JSON   = Path(__file__).parent.parent / "js" / "data" / "mn_reports.json"
