...
function kop_enqueue_report_scripts() {
    $reports = array(
        ...
        'ut-reports' => array(
            ...
            'script_path'   => '/js/inspections/states/ut.js',
            ...
            // Rollback: point script_path back at /js/inspections/ut_reports.js
            // and drop this flag.
            'report_page'   => true,
        ),
        'az-reports' => array(
        ...
        'mt-reports' => array(
            ...
            'script_path'   => '/js/inspections/states/mt.js',
            'data_object'   => 'mtReportsData',
            'json_glob'     => get_stylesheet_directory() . '/js/data/mt_reports.json',
            // Adapter for the shared js/inspections/report-page.js engine.
            // Rollback: point script_path back at /js/inspections/mt_reports.js
            // and drop this flag.
            'report_page'   => true,
        ),
        'ct-reports' => array(
        ...
        'mn-reports' => array(
            ...
            'script_path'   => '/js/inspections/states/mn.js',
            'data_object'   => 'mnReportsData',
            'json_glob'     => get_stylesheet_directory() . '/js/data/mn_reports.json',
            // Adapter for the shared js/inspections/report-page.js engine.
            // Rollback: point script_path back at /js/inspections/mn_reports.js
            // and drop this flag.
            'report_page'   => true,
        ),
        'nc-reports' => array(
        ...
        'nv-reports' => array(
            ...
            'script_path'   => '/js/inspections/states/nv.js',
            'data_object'   => 'nvReportsData',
            'json_glob'     => '',
            // Adapter for the shared js/inspections/report-page.js engine.
            // Rollback: point script_path back at /js/inspections/nv_reports.js
            // and drop this flag.
            'report_page'   => true,
        ),
        'or-reports' => array(
...
function kop_enqueue_template_assets() {
    ...
    if (kop_page_uses_template('page-network-map.php')
        ...
        foreach (array('store', 'canvas', 'viewport', 'focus', 'connection', 'search', 'filters', 'drawer', 'card', 'path', 'keys', 'url-state', 'app') as $module) {
