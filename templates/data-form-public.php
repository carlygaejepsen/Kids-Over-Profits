...
?>
    ...
    <div class="container">
        ...
        <!-- Project Loader Panel (Outside Toolbar) -->
        <div class="project-loader-panel" style="background: #FFF5CB; border: 2px solid #33A7B5; border-radius: 8px; padding: 20px; margin: 20px 0;">
            ...
            <div class="form-group">
                ...
                <div id="quick-projects-list" style="max-height: 200px; overflow-y: auto; border: 1px solid #33A7B5; border-radius: 6px; padding: 10px; background: #FFFFFF; margin-top: 8px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="clone-option" style="margin-bottom: 15px; padding: 10px; border: 1px solid #e5e7eb; border-radius: 6px;">
                    <label style="color: #1f2937; cursor: pointer; display: block;">
                        <input type="radio" name="clone-destination" value="current" checked style="margin-right: 8px;">
                ...
                <div class="clone-option" style="margin-bottom: 15px; padding: 10px; border: 1px solid #e5e7eb; border-radius: 6px;">
                    <label style="color: #1f2937; cursor: pointer; display: block;">
                        <input type="radio" name="clone-destination" value="existing" style="margin-right: 8px;">
                        Clone to an existing project
                    </label>
                    <div class="project-select-container" id="existing-project-container" style="display: none; margin-top: 10px; margin-left: 24px;">
                        <select class="project-select" id="existing-project-select" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 4px;">
                ...
                <div class="clone-option" style="margin-bottom: 15px; padding: 10px; border: 1px solid #e5e7eb; border-radius: 6px;">
                    <label style="color: #1f2937; cursor: pointer; display: block;">
                        <input type="radio" name="clone-destination" value="new" style="margin-right: 8px;">
                        Clone to a new project
                    </label>
                    <div class="project-select-container" id="new-project-container" style="display: none; margin-top: 10px; margin-left: 24px;">
