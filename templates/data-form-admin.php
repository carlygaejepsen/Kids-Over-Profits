...
?>
    ...
    <div class="container">
        ...
        <div class="section" id="target-profile-section" data-section-views="companies,locations">
            ...
            <div class="section-content">
                <?php kop_form_panel_help('targeted-diagnoses-behaviors', 'section-help'); ?>
                <div class="sub-section">
                    <div class="sub-section-header"><h3 class="sub-section-title">Clinical Diagnoses</h3><span class="sub-section-toggle">▼</span></div>
                    <div class="sub-section-content">
                ...
                <div class="sub-section">
                    <div class="sub-section-header"><h3 class="sub-section-title">Behaviors &amp; Challenges</h3><span class="sub-section-toggle">▼</span></div>
                    <div class="sub-section-content">
        ...
        <div class="section" id="common-tti-practices-section" data-section-views="companies,locations">
            <div class="section-header"><h2 class="section-title">Common TTI Practices</h2><span class="section-toggle"></span></div>
            <div class="section-content">
                <?php kop_form_panel_help('common-tti-practices', 'section-help'); ?>
