 ...
 */
export function escapeHtmlForAttr(s) {
 ...
 */
export function parseStaffString(s) {
 ...
 */
export function mergeIntoOriginal(original, normalized) {
 ...
 */
export function addToStorageArray(key, value) {
 ...
 */
export function getUniqueFilteredSorted(arr) {
 ...
 */
export function addToSet(set, items) {
 ...
 */
export function attachListenersToIds(ids, eventType, handler) {
    ids.forEach(id => {
 ...
 * @param {Function} handler - Event handler function
 */
export function attachListenersToSelector(selector, eventType, handler) {
 ...
 */
export function toggleElVisibility(id, show) {
    const el = getEl(id);
    if (el) {
