...
State approved non-public schools are required to maintain a curriculum that is equal or similar to public schools. Requirements for graduation in a non-public school are the same as that in a public school and no more than 35 students can be enrolled in each class with the exception of music, art and physical education.

New students in non-public schools must show proof of immunization or proper paperwork that shows exemption. The state health officer is in charge of determining the rules and regulations regarding health and safety for private schools.

---

***Below is a list of active programs that currently operate in Louisiana.***
...
***Below is a list of now closed programs that used to operate in Louisiana.***
