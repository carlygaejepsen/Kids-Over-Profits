...
• Requiring parents to address mail to the program instead of their child, so that the program can legally withhold, open, and tamper with, any mail or packages sent to the child in their custody.

• Dress code (for example: require youth to wear jumpsuits or flip-flops, or enforced head-shaving),
...
^(*For example, ADHD, Bipolar Disorder, PTSD, Eating Disorders, Depressive Disorders, Anxiety Disorders, Substance Abuse.)

^(**for example, licensed psychologists, psychiatrists, clinical social workers, marriage/family therapists and psychiatric nurses.)
...
• Parents must agree to pay for services not rendered if youth leaves the program,
...
*This information has been copied and adapted from ASTART and is reproduced here for educational and informational purposes only. All rights are reserved to ASTART. The original downloadable PDF of this information can be found by [clicking here](http://astartforteens.org/assets/files/ASTART-Facts-and-Warning-Signs.pdf) .*
